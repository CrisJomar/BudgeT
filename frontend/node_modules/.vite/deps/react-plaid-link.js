...
var scripts = {};
var checkExisting = function checkExisting2(src) {
...
function useScript(_ref) {
  ...
  var _useState = (0, import_react.useState)(status ? status.loading : Boolean(src)), _useState2 = _slicedToArray(_useState, 2), loading = _useState2[0], setLoading = _useState2[1];
  var _useState3 = (0, import_react.useState)(status ? status.error : null), _useState4 = _slicedToArray(_useState3, 2), error = _useState4[0], setError = _useState4[1];
  var _useState5 = (0, import_react.useState)(false), _useState6 = _slicedToArray(_useState5, 2), scriptLoaded = _useState6[0], setScriptLoaded = _useState6[1];
